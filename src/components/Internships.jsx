        ...
        >
            ...
            <div className="text-center mb-16">
                ...
                <p className="text-gray-400 mt-4 text-lg font-semibold">
                    A concise showcase of my professional experience and the roles I’ve undertaken across various organizations
                </p>
            </div>
            ...
            <div className="relative max-w-6xl mx-auto">
                ...
                {internships.map((experience, index) => (
                    ...
                    >
                        {/* Content */}
                        <div
                            className={`w-full max-w-lg p-6 sm:p-8 rounded-2xl shadow-2xl border-2 border-purple-500 bg-gray-900 backdrop-blur-md shadow-purple-500/30 transform transition-transform duration-300 hover:scale-105 ${
